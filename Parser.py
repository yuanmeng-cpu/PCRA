...
def getParser():
    ...
    # transformer encoder
    parser.add_argument("-n_heads", "--n_heads", type=int, default=3)
    parser.add_argument("-n_layers", "--n_layers", type=int, default=2)
    parser.add_argument("-embedding_size","--embedding_size",type=int,default=300)
    parser.add_argument("-ffn_size", "--ffn_size", type=int, default=300)
    parser.add_argument("-dropout", "--dropout", type=float, default=0.1)
    parser.add_argument("-attention_dropout","--attention_dropout",type=float,default=0.0)
    parser.add_argument("-relu_dropout","--relu_dropout",type=float,default=0.1)
